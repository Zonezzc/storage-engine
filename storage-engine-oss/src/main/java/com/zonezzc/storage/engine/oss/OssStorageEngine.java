package com.zonezzc.storage.engine.oss;

import com.aliyun.oss.OSS;
import com.aliyun.oss.model.OSSObject;
import com.zonezzc.storage.engine.oss.config.OssStorageEngineConfig;
...
public class OssStorageEngine extends AbstractStorageEngine {
	...
	protected void doDelete(DeleteFileContext context) throws IOException {
		...
		realFilePathList.forEach(realPath -> ossClient.deleteObject(config.getBucketName(), realPath));
	}
	...
	protected void doDownloadUrl(DownloadUrlContext context) throws IOException {
		...
		URL url = ossClient.generatePresignedUrl(config.getBucketName(), context.getRealPath(), expiration);
